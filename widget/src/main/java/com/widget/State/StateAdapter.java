...
import com.widget.Adpater.Impliment.MixAdapter;
...
public class StateAdapter extends MixAdapter implements IShowStateInterface {
    ...
    private Map<StateEnum, Integer> viewids = new HashMap<>(4);
    ...
    public StateAdapter setStateHandler(IStateHandlerInterface stateHandler) {
     ...
     * @return
     */
    public StateAdapter setStateListener(IStateListener listener) {
